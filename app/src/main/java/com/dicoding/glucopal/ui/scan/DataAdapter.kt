...
class DataAdapter(private var userId: String) : ListAdapter<DataItem, DataAdapter.MyViewHolder>(DIFF_CALLBACK) {
    ...
    class MyViewHolder(private val binding: ItemCategoryBinding, private val userId: String) :
